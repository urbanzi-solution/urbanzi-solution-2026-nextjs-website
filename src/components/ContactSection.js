    ...
    <section className="bg-black text-white py-20 md:py-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="w-20 md:w-24 h-[3px] bg-white mx-auto mt-6 mb-6 rounded-full" />
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <input type="email" placeholder="you@company.com" required className="contact-input" />
              </div>
              ...
              <div>
                ...
                <textarea rows="4" placeholder="Tell us about your project..." required className="contact-input resize-none" />
              </div>
        ...
        {/* CONTACT INFO */}
        <motion.div
          className="text-center mt-14 md:mt-16 text-gray-400 text-sm"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6, delay: 0.1, ease }}
        >
          <p className="mb-4">Or reach out to us directly:</p>
          <div className="flex justify-center gap-6 md:gap-10 flex-wrap">
            <a href="mailto:contact@urbanzi.in" className="hover:text-blue-500">contact@urbanzi.in</a>
