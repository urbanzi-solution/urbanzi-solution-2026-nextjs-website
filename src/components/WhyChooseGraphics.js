      ...
      <div className="relative max-w-6xl mx-auto">
        <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.4 }} transition={{ duration: 0.7, ease }}>
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            We combine creativity with strategy to create visuals that capture attention and drive real business results.
          </p>
        </motion.div>
        ...
        <motion.div className="mt-20 text-center" initial={{ opacity: 0, y: 24, scale: 0.97 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} viewport={{ once: true, amount: 0.4 }} transition={{ duration: 0.7, delay: 0.2, ease }}>
          <div className="max-w-3xl mx-auto bg-[#0f1629]/80 border border-white/10 rounded-2xl p-8 backdrop-blur-md">
            <p className="text-xl md:text-2xl text-gray-200 leading-relaxed">
              ...
              <br />
              <span className="text-blue-400 font-semibold">We design for attention, clarity, and conversion.</span>
            </p>
          </div>
        </motion.div>
      </div>
